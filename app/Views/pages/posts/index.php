...
<?php $this->section('content') ?>
    ...
    <div class="px-4 py-4 mt-8 bg-white rounded-lg lg:px-8 lg:py-6">
              ...
              <?php if($posts): ?>
                <?php foreach($posts as $index => $data): ?>
                    ...
                    <tr>
                        ...
                        <td class="px-3 py-3"><?php echo $data['image'] ?></td>
                ...
                <?php else: ?>
                    <tr>
                        <td class="px-3 py-3">No data found.</td>
                    </tr>
              <?php endif; ?>
      ...
      <a href="#" class="inline-block mt-5 font-bold text-blue-600 hover:underline">View all orders</a>
    </div>
